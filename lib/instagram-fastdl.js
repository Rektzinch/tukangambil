...
const WEB_SIGNATURE_SECRET = "74fe182c082a17e63545a7c84fa74eb36ec37e6a8154f1a4d1478a7917e7fd59";
const WEB_SIGNATURE_TIMESTAMP = 1785411663296;
...
function isEnabled() {
  ...
  return Boolean(cfg.apiUrl && (cfg.apiKey || webSignatureConfig().secret));
}

function webSignatureConfig() {
  return {
    secret: String(process.env.FASTDL_WEB_SIGNATURE_SECRET || WEB_SIGNATURE_SECRET).trim(),
    timestamp: Number(process.env.FASTDL_WEB_SIGNATURE_TIMESTAMP || WEB_SIGNATURE_TIMESTAMP)
  };
}
